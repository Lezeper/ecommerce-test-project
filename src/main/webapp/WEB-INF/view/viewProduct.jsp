                                    ...
                                    <div id="demo-1" class="simpleLens-gallery-container">
                                        <div class="simpleLens-container">
                                            <div class="simpleLens-big-image-container">
                                                <a data-lens-image="<c:url value="/resources/images/${product.productId}/0.png" />" class="simpleLens-lens-image">
                                                    <img src="<c:url value="/resources/images/${product.productId}/0.png" />" class="simpleLens-big-image">
                                                </a>
                                            </div>
                                        </div><!--
                                        <div class="simpleLens-thumbnails-container">
                                            <a data-big-image="<c:url value="/resources/images/${product.productId}/0.png" />"
                                               data-lens-image="<c:url value="/resources/images/${product.productId}/0.png" />"
                                               class="simpleLens-thumbnail-wrapper" href="<c:url value="/resources/images/${product.productId}/0.png" />">
                                                <img style="width: 50px;height: 50px" src="<c:url value="/resources/images/${product.productId}/0.png" />">
                                            </a>
                                        </div>-->
                                    </div>
                                </div>
                                ...
                                <div class="aa-product-view-content">
                                    ...
                                    <div class="aa-prod-quantity">
                                        ...
                                        <p class="aa-prod-category">
                                            Category:
                                            <a href="<spring:url value="/products/${product.productCategory.toLowerCase()}?sc=${product.productSubCategory}" />">
                                            ${product.productCategory} - ${product.productSubCategory}
                                        </a>
                                        </p>
                                    </div>
                                    <div>
                                        <p>Views: ${fn:substringBefore(product.productViews/2, '.')}</p>
                                        <p>Date First Available: ${product.productDate}</p>
                                    </div>
                                    <div class="aa-prod-view-bottom" ng-controller="cartCtrl">
                                        <a class="aa-add-to-cart-btn" href="<spring:url value="/customer/cart"/>"
                            ...
                            <div class="tab-pane fade " id="review">
                                <div class="aa-product-review-area">
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <h4 class="media-heading">
                                                        <strong>${productComment.commentCustomerName}</strong> - <span>${productComment.commentDate}</span>
                                                    </h4>
                                    ...
                                    <div id="add-review-div" hidden>
                                        <!-- review form -->
                                        <form:form action="${pageContext.request.contextPath}/products/viewProduct/${product.productId}"
                                            ...
                                            <div class="form-group">
                                                <form:hidden path="commentCustomerName" value="${customer_name}"/>
                                            </div>
                                            <div class="form-group">
                                                <form:hidden path="commentCustomerEmail" value="${pageContext.request.userPrincipal.name}"/>
                                            </div>
