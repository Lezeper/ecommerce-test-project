        ...
        <div id="sequence" class="seq">
            <div class="seq-screen">
                <ul class="seq-canvas">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq style="width: 1920px; height: 700px; object-fit: cover;" src="<c:url value="/resources/images/slider/${slider.sliderId}/0.png" />"/>
                        </div>
                        <div class="seq-title">
                            <span data-seq>${slider.sliderUpperData}</span>
                            <h2 data-seq>${slider.sliderTitle}</h2>
                            <p data-seq>${slider.sliderDescription}</p>
                            <a data-seq href="/products/${slider.sliderLink}" class="aa-shop-now-btn aa-secondary-btn">SHOP NOW</a>
                        </div>
                    </li>
                    </c:forEach>
                </ul>
                        ...
                        <div class="col-md-5 no-padding">
                            <div class="aa-promo-left">
                                <div class="aa-promo-banner">
                                    <img style="object-fit: cover;" src="<spring:url value="/resources/img/for-women-450x450.jpg"/>" alt="img">
                                    <div class="aa-prom-content">
                                        <span>75% Off</span>
                                        <h4><a href="/products/women">For Women</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 no-padding">
                            <div class="aa-promo-right">
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">
                                        <img style="object-fit: cover;" src="<spring:url value="/resources/img/for-men-300x220.jpg"/>" alt="img">
                                        <div class="aa-prom-content">
                                            <span>Exclusive Item</span>
                                            <h4><a href="/products/men">For Men</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">
                                        <img src="<spring:url value="/resources/img/for-shoes.jpg"/>" alt="img">
                                        <div class="aa-prom-content">
                                            <span>On Sale</span>
                                            <h4><a href="/products/all?sc=shoes">On Shoes</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">
                                        <img src="<spring:url value="/resources/img/for-kids.jpg"/>" alt="img">
                                        <div class="aa-prom-content">
                                            <span>New Arrivals</span>
                                            <h4><a href="/products/kids">For Kids</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">
                                        <img style="object-fit: cover;" src="<spring:url value="/resources/img/for-bags.jpg"/>" alt="img">
                                        <div class="aa-prom-content">
                                            <span>25% Off</span>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="${category}">
                                    ...
                                    <c:forEach items="${products}" var="product">
                                        <c:if test="${category eq product.productCategory}">
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="<c:url value="/products/viewProduct/${product.productId}" />">
                                                    <img style="width: 250px; height: 300px" src="<c:url value="/resources/images/${product.productId}/0.png" />" ></a>
                                                <a class="aa-add-card-btn" href="<spring:url value="/customer/cart"/>" ng-click="addToCart('${product.productId}')">
                                                    <span class="fa fa-shopping-cart"></span>Add To Cart
                                                </a>
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="<c:url value="/products/viewProduct/${product.productId}" />">${product.productName}</a></h4>
                                    ...
                                    <a class="aa-browse-btn" href="/products/${category}">Browse all Product <span
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="<spring:url value="/resources/img/banner-footer-1170x170.jpg" />" alt="fashion banner img"></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="aa-popular-category-area">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="popular">
                                ...
                                <a class="aa-browse-btn" href="/products/all">Browse all Product <span
                                        class="fa fa-long-arrow-right"></span></a>
                            </div>
