                    ...
                    <div class="aa-product-catg-head">
                        <div class="aa-product-catg-head-left">
                            <form action="" class="aa-sort-form">
                                ...
                                <select name="" onchange="sortBy(this)">
                                    <option value="<my:replaceParam name='sort' value='default' />" selected>Default</option>
                                    <option value="<my:replaceParam name='sort' value='productPrice-ASC' />">Price Ascending</option>
                                    <option value="<my:replaceParam name='sort' value='productPrice-DESC' />">Price Descending</option>
                                </select>
                            </form>
                                ...
                                <li id="product-li-number-${counter}">
                                    <figure>
                                        ...
                                        <figcaption>
                                            ...
                                            <span class="aa-product-descrip">${product.productDescription}</span>
                                        </figcaption>
                                    </figure>
                                    <!-- product badge -->
                ...
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <c:forEach items="${categoryList}" var="category">
                            <li><a href="<spring:url value="/products/${keyword}?sc=${category}" />">${category}</a></li>
                        </c:forEach>
                        </ul>
                    </div>
